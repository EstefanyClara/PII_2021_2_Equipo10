...
namespace Proyect
{
    ...
    {
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="StartHandler"/>. Esta clase procesa el mensaje "/start" y muestras las funcionalidades bases del programa.
        /// </summary>
